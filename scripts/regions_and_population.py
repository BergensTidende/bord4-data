...
years = list(map(str, list(range(2001, YEAR+1))))
...
def get_population_counties():
    ...
    json_q = {"query":[{"code":"Region","selection":{"filter":"agg:KommFylker","values":["F-30","F-03","F-34","F-38","F-42","F-11","F-46","F-15","F-50","F-18","F-54","F-21","F-22","F-23"]}},{"code":"Alder","selection":{"filter":"vs:AlleAldre00B","values":[]}}, {"code":"Tid","selection":{"filter":"item","values":years}}],"response":{"format":"json-stat2"}}
